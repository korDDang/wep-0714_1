...
int cnt=0;
try{
	String sql="select count(*) from sub0714";
...
<section id="sec1">
<h2>교과목 목록</h2>
<div style="margin: 0 10%">총 <%=cnt %>개의 교과목이 있습니다.</div>
<hr>
...
<th class="th1">죵료시간</th>
</tr>
<% 
int no=0;
try{
	String sql="select l.idx,l.name,s.id,s.subject_name,s.credit,s.week,s.start_hour,s.end_hour from sub0714 s,lecturer0714 l where s.lecturer=l.idx order by l.idx asc, s.id asc";
	pstmt=conn.prepareStatement(sql);
	rs=pstmt.executeQuery();
	while(rs.next()){
